...
function ActivitiesDetails() {
  ...
  useEffect(() => {
    const getDataById = async (id) => {
      const response = await axios.get(
        `https://backend.loglife.prutmongkol.dev/v2/activities/${id}`,
        {
  ...
  const handleDelete = async () => {
    const response = await axios.delete(
      `https://backend.loglife.prutmongkol.dev/v2/activities/${activityId}`,
      {
        withCredentials: true,
      },
    );
  ...
  const handleUploadImage = async (modal, inputId) => {
    ...
    const response = await axios.post(
      `https://backend.loglife.prutmongkol.dev/v2/activities/${activityId}/image`,
      formData,
      {
        withCredentials: true,
      },
  ...
  const handleDeleteImage = async (modal) => {
    ...
    const response = await axios.delete(
      `https://backend.loglife.prutmongkol.dev/v2/activities/${activityId}/image/${publicId}`,
      {
        withCredentials: true,
      },
    );
